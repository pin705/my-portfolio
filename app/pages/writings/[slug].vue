...
const { copy, copied } = useClipboard({
  source: `${window.location.hostname}/writings/${route.params.slug}`,
  copiedDuring: 4000
})
...
<i18n lang="json">
{
  ...
  "thanks": "Cảm ơn bạn đã đọc bài viết này! Nếu bạn thích nó, hãy cân nhắc chia sẻ với bạn bè. {like}",
  "like": "Đừng quên để lại một lượt thích!",
  "link": {
