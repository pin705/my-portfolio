...
<i18n lang="json">
{
  ...
  "vi": {
  "title": "Viết về cuộc sống, phát triển và đam mê của tôi.",
  "description": "Tất cả suy nghĩ của tôi về lập trình, toán học, thiết kế trí tuệ nhân tạo, v.v., được sắp xếp theo thứ tự thời gian. Tôi cũng viết về các dự án của mình, những khám phá và suy nghĩ của tôi.",
  "likes": {
    "one": "thích",
    "many": "lượt thích"
  },
  ...
  "alert": {
    "title": "Cảnh báo dịch thuật!",
    "description": "Do hạn chế về thời gian, tất cả các bản dịch bài viết sẽ chỉ có sẵn bằng tiếng Anh. Cảm ơn bạn đã thông cảm."
  }
}
}
</i18n>
